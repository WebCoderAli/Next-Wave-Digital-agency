            ...
            <div class="row g-4 justify-content-center align-items-center">
                ...
                <div class="col-lg-4 col-md-6 z-index-1">
                    <div class="glass-card glass-card-hover pricing-card-premium text-center">
                        ...
                        <ul class="plan-features-premium text-start">
                            <li><i class="check">✓</i> 1 Page Website</li>
                            <li><i class="check">✓</i> Basic Design</li>
                            <li><i class="check">✓</i> Mobile Responsive</li>
                            <li><i class="check">✓</i> Standard Email Support</li>
                            <li><i class="x-mark">✗</i> Custom Admin Panel</li>
                            <li><i class="x-mark">✗</i> SEO Optimization</li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-6 z-index-2">
                    <div class="glass-card pricing-card-premium pricing-card-featured text-center">
                        ...
                        <ul class="plan-features-premium text-start">
                            <li><i class="check">✓</i> 5 Pages Website</li>
                            <li><i class="check">✓</i> Premium Custom Design</li>
                            <li><i class="check">✓</i> Mobile Responsive</li>
                            <li><i class="check">✓</i> Basic Admin Panel</li>
                            <li><i class="check">✓</i> SEO Optimization</li>
                            <li><i class="check">✓</i> Priority Support</li>
                        </ul>
                ...
                <div class="col-lg-4 col-md-6 z-index-1">
                    <div class="glass-card glass-card-hover pricing-card-premium text-center">
                        ...
                        <ul class="plan-features-premium text-start">
                            <li><i class="check">✓</i> Unlimited Pages</li>
                            <li><i class="check">✓</i> Advanced Admin System</li>
                            <li><i class="check">✓</i> Full E-Commerce Features</li>
                            <li><i class="check">✓</i> Marketing Strategy Session</li>
                            <li><i class="check">✓</i> Deep SEO Strategy</li>
                            <li><i class="check">✓</i> 24/7 Dedicated Support</li>
                        </ul>

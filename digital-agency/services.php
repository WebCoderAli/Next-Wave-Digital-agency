    ...
    <section class="premium-section" style="padding-top: 150px; padding-bottom: 80px; overflow: hidden;">
        ...
        <div class="container text-center position-relative" style="z-index: 1;">
            ...
            <p class="services-subtitle lead text-secondary mx-auto" style="max-width: 650px; font-size: 1.25rem;">
                ...
                grow, scale, and stand out in an increasingly competitive world.
            </p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5 pb-5">
                <div class="col-lg-6 mb-5 mb-lg-0 pe-lg-5">
                    ...
                    <ul class="service-list-premium mb-0">
                        <li class="text-secondary">Custom PHP & MySQL systems</li>
                        <li class="text-secondary">High-performance SPA & Responsive design</li>
                        <li class="text-secondary">Secure Admin Dashboards</li>
                        <li class="text-secondary">Enterprise E-commerce portals</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row align-items-center flex-lg-row-reverse mb-5 pb-5">
                <div class="col-lg-6 mb-5 mb-lg-0 ps-lg-5">
                    ...
                    <ul class="service-list-premium mb-0">
                        <li class="text-secondary">Premium Logo & Branding Guidelines</li>
                        <li class="text-secondary">User-centric UI/UX Design Models</li>
                        <li class="text-secondary">High-converting Marketing Creatives</li>
                        <li class="text-secondary">Social media assets and graphics</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <div class="service-image-glass">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0 pe-lg-5">
                    ...
                    <ul class="service-list-premium mb-0">
                        <li class="text-secondary">Deep Search Engine Optimization (SEO)</li>
                        <li class="text-secondary">Viral Social Media Marketing</li>
                        <li class="text-secondary">High ROI Paid Advertising (PPC)</li>
                        <li class="text-secondary">Strategic Content Strategy</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <div class="service-image-glass">
            ...
            <!-- UI/UX DESIGN -->
            <div class="row align-items-center flex-lg-row-reverse mt-5 pt-5">
                <div class="col-lg-6 mb-5 mb-lg-0 ps-lg-5">
                    <div class="d-inline-flex align-items-center gap-3 mb-4">
                        <div class="why-icon-box m-0" style="width: 50px; height: 50px; font-size: 1.2rem; background: rgba(244, 114, 182, 0.1); border-color: rgba(244, 114, 182, 0.3);">🧩</div>
                        <h2 class="fw-bold mb-0">UI/UX Design</h2>
                    </div>
                    <p class="text-secondary fs-5 mb-4" style="line-height: 1.7;">
                        We design intuitive user journeys and modern interfaces that
                        improve usability, increase engagement, and drive conversions.
                    </p>
                    <ul class="service-list-premium mb-0">
                        <li class="text-secondary">User research & behavior mapping</li>
                        <li class="text-secondary">Wireframes and interactive prototypes</li>
                        <li class="text-secondary">Design systems and component libraries</li>
                        <li class="text-secondary">Mobile-first and responsive UX flows</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <div class="service-image-glass">
                        <img src="assets/images/services/uiux.avif"
                             class="img-fluid w-100"
                             alt="UI UX Design"
                             onerror="this.src='https://images.unsplash.com/photo-1545239351-1141bd82e8a6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80';">
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center mt-5 pt-5">
                <div class="col-lg-6 mb-5 mb-lg-0 pe-lg-5">
                    <div class="d-inline-flex align-items-center gap-3 mb-4">
                        <div class="why-icon-box m-0" style="width: 50px; height: 50px; font-size: 1.2rem; background: rgba(59, 130, 246, 0.1); border-color: rgba(59, 130, 246, 0.3);">🔎</div>
                        <h2 class="fw-bold mb-0">SEO Optimization</h2>
                    </div>
                    <p class="text-secondary fs-5 mb-4" style="line-height: 1.7;">
                        We optimize your site for search engines so your brand ranks
                        higher, attracts qualified traffic, and grows organically.
                    </p>
                    <ul class="service-list-premium mb-0">
                        <li class="text-secondary">Technical SEO audits and fixes</li>
                        <li class="text-secondary">On-page optimization for core pages</li>
                        <li class="text-secondary">Keyword strategy and content structure</li>
                        <li class="text-secondary">Performance, schema, and indexing improvements</li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    <div class="service-image-glass">
                        <img src="assets/images/services/seo.avif"
                             class="img-fluid w-100"
                             alt="SEO Optimization"
                             onerror="this.src='https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80';">
                    </div>
                </div>
            </div>
